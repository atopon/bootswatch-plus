...
<jsp:include page="/common/header.jsp">
  <jsp:param name="title" value="Glyphs"/>
</jsp:include>

<jsp:include page="/common/menu.jsp">
  <jsp:param name="menu" value="glyphs"/>
</jsp:include>


<div class="container">

<h3>Glyphs - Glyphicons</h3>

<p class="text-muted">(don't forget to copy files to ../fonts/ relative to the CSS file.</p>

<p>Includes over 250 glyphs in font format from the Glyphicon Halflings set.
  <a href="http://glyphicons.com/">Glyphicons</a> Halflings are normally not available for free,
  but their creator has made them available for Bootstrap free of cost. As a thank you,
  we only ask that you include a link back to <a href="http://glyphicons.com/">Glyphicons</a>
  whenever possible.
</p>

<div class="bs-glyphicons">
<ul class="bs-glyphicons-list list-unstyled list-inline">
